...
python /opt/MoonGen/libmoon/deps/dpdk/usertools/dpdk-devbind.py -u 0000:23:00.1

python /opt/MoonGen/libmoon/deps/dpdk/usertools/dpdk-devbind.py --bind=igb_uio 0000:21:00.0

python /opt/MoonGen/libmoon/deps/dpdk/usertools/dpdk-devbind.py --status
