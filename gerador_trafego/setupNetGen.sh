...
arq_save="/home/igorcapeletti/github/tcc_eBPF_XDP/resultados/$nome_pasta_resultados/res_combined_$combined+algoritmo_$nome_pasta_resultados+pkt_$packet_size+ebpf_$modo_hook_xdp+varIP_$var_dst_IP+timeout_$timeout"
