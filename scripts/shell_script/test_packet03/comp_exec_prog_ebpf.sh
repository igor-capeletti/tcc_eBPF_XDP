cd /home/igorcapeletti/libbpf/xdp-tutorial/packet03-redirecting
make
...
ip netns exec ns2 ip link set dev ens2f0 xdpgeneric obj xdp_prog_kern.o sec xdp_icmp_echo
#ou
#ip netns exec ns2 ip link set dev ens2f0 xdpgeneric obj xdp_prog_kern.o sec xdp_redirect
#ou
#ip netns exec ns2 ip link set dev ens2f0 xdpgeneric obj xdp_prog_kern.o sec xdp_redirect_map
#ou
